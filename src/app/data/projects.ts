...
Features include a summary dashboard with stat cards and donut charts, a waterfall timeline with phase-level color coding, performance analysis with slow-request detection and duplicate request grouping, automated security checks (missing headers, insecure cookies, mixed content, sensitive data in URLs), and a filterable request table with a full request inspector panel.`,
    ...
    coverImage: 'images/projects/har-analyzer/screenshot-2.webp',
    screenshots: [
      'images/projects/har-analyzer/screenshot-2.webp',
      'images/projects/har-analyzer/screenshot-7.webp',
      'images/projects/har-analyzer/screenshot-1.webp',
      'images/projects/har-analyzer/screenshot-3.webp',
      'images/projects/har-analyzer/screenshot-8.webp',
      'images/projects/har-analyzer/screenshot-4.webp',
      'images/projects/har-analyzer/screenshot-5.webp',
      'images/projects/har-analyzer/screenshot-6.webp',
    ],
  },
  {
    slug: 'olj-jd-helper',
...
Visit a job posting and the description is automatically saved. Click Apply and a toggle button appears on the form page. Click it to open a sidebar with the full job description alongside the form. Saved descriptions expire after 24 hours. Built with vanilla JavaScript using Chrome's Manifest V3.`,
    ...
    coverImage: 'images/projects/olj-jd-helper/screenshot-2.webp',
    screenshots: [
      'images/projects/olj-jd-helper/screenshot-2.webp',
      'images/projects/olj-jd-helper/screenshot-1.webp',
      'images/projects/olj-jd-helper/screenshot-3.webp',
    ],
  },
];
